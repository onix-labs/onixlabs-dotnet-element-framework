...
The architectural sharp edges that trip up first-time contributors. Most are explained in more depth in [architecture.md §15](architecture.md#15-known-constraints-and-non-goals) and [production-readiness.md](production-readiness.md).
...
| Test fixtures (blog application) | `OnixLabs.ElementFramework.Conformance/TestFixtures/BlogApplication/` | [arch §13.2](architecture.md#132-conformance-suite-onixlabselementframeworkconformance) |
| Conformance suite (provider-agnostic tests) | `OnixLabs.ElementFramework.Conformance/AbstractGraphContextIntegrationTests.cs` | [arch §13.2](architecture.md#132-conformance-suite-onixlabselementframeworkconformance) |
| Unit-test fakes | `OnixLabs.ElementFramework.UnitTests/TestFixtures.cs` | [arch §13.1](architecture.md#131-unit-tests) |
| CI pipeline | `.github/workflows/ci.yml` | [arch §13.4](architecture.md#134-ci) |
| Framework diagnostics surface | `ElementFrameworkDiagnostics.cs` | [arch §12](architecture.md#12-diagnostics-surface) |
| Provider diagnostics surface | `Neo4jDiagnostics.cs`, `AgeDiagnostics.cs` | [arch §12.3](architecture.md#123-provider-spans) |

When adding a new provider, the checklist is in [architecture.md §14](architecture.md#14-adding-a-new-provider).
